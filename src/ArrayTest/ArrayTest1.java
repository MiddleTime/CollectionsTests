...
public class ArrayTest1 {
    public static void main(String[] args) {
        List<Integer> arrayList = new ArrayList<>();  //не указываем размер нашей коллекции, хотя это возможно
        for (int i = 0; i < 100; i++) {
            arrayList.add(i);
        }
        ...
        arrayList.remove(99);  
        /// легко удалять элементы   (но очень не эффективно если удаляется элемент в середине или вначае)
